...
static constexpr auto binary_search_ranges(Range&& range, const T& value, Proj&& proj = {}) {
...
constinit static const auto keywords_list = []() {
    ...
    std::array keywords = {
        ...
        std::pair("export"sv, Token_type::KEYWORD_EXPORT), std::pair("as"sv, Token_type::KEYWORD_AS), std::pair("as"sv, Token_type::TYPE_BOOL)};
